...
import { getRulesRemplacer, getRulesSupprimer } from "./notion-rules";

test('gets 2 remplacer rules', () => {
  const pages = [
    {
      object: 'page',
  ...
  expect(getRulesRemplacer(pages)).toStrictEqual(rulesObject);
});

test('gets 2 supprimer rules', () => {
  const pages = [
    {
      object: 'page',
      id: '1b08a85a-23b4-4745-a02a-76f3f6e073d7',
  ...
  expect(getRulesSupprimer(pages)).toStrictEqual(rulesArray);
});